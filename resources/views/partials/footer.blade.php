    ...
    <div class="row">
      <div class="col-lg-6 content-left">
        ...
        <address>
          ...
          <span>{{$address['address_line_2']}}</span><br><br>
          <a href="tel:+1{{$phone_link}}" class="phone"><span>{{$address['phone_number']}}</span></a>
        </address>
        <div class="hours">
        ...
        <div class="copyright">
          <p>&copy; Copyright {{date("Y")}} - Manifesto Coffee Co. | <a href="/sitemap">Sitemap</a></p>
        </div>
      </div>
